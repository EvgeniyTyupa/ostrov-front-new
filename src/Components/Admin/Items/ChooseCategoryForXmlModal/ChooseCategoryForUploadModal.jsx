...
import classes from "./ChooseCategoryForUploadModal.module.css"
...
const ChooseCategoryForUploadModal = (props) => {
    const {
        onClose,
        categories,
    ...
    return (
        <Modal
            onClose={handleClose}
            title={`Выберите категорию товаров, из которой вы хотите выгрузить ${uploadType}`}
        >
